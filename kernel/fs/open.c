...
//<2013/07/30-27389-kevincheng,Add debug message for can't save file issue
        printk(">>> chmod_common , path->dentry->d_name.name : %s , mode : %x\r\n <<<",path->dentry->d_name.name,mode);
//>2013/07/30-27389-kevincheng
