...
again:
  ...
  // SONY wants a shutdown when cable is disconnected
  while(usb_wrapper_vbus_det());
  misc_wrapper_shutdown();
#endif
}
...
#ifndef SONY_S1_SUPPORT // SONY has customized behaviour of the commands
#ifndef USER_BUILD
