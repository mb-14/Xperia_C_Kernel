...
*
********************************************************************************/
// Arima_HCSW7_20130610_JohnnyZheng - [ThunderSoft] Pelican-delivery-20130609
// Change from
// 2,   // i4VAFC_MODE  0 : singleAF, 1:smoothAF 2: smoothAF & use 3-pointers for curve fitting only
// To
...
getAFParam()
{
    static AF_PARAM_T g_AFparam = 
    {
        ...
        2,   // i4AFC_MODE  0 : singleAF, 1:smoothAF, 2: touch continuousAF
