...
ssize_t gpio_FL_Enable(void)
{
	...
	printk("[gpio_flash] gpio_FL_Enable g_duty = %d\n", g_duty);
...
//<2013/7/4-26598-jessicatseng, [5860] Read back the flags register (0x0B) of flashlight IC
	databuf[0] = 0x0B;
	ret = i2c_master_send(flashlight_i2c_client, (const char*)&databuf[0], 1);
	databuf[1] = 0xFF;
	ret = i2c_master_recv(flashlight_i2c_client, (char*)&databuf[1], 1);
	
	printk("[gpio_flash] gpio_FL_Enable reg(0x0B) = 0x%x, ret = %d\n", databuf[1], ret);
//>2013/7/4-26598-jessicatseng	
...
//<2013/6/27-26383-jessicatseng, [5860][Coverity][89727][89728][89729][90004]
    return 0;
//>2013/6/27-26383-jessicatseng    
}
//>2013/4/12-23739-jessicatseng
