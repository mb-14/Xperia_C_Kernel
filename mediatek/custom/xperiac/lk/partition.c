...
struct part_name_map g_part_name_map[PART_MAX_COUNT] = {
	...
	{"uboot",	PART_UBOOT,	"raw data",	9,	1,	1},
	{"boot",	PART_BOOTIMG,	"raw data",	10,	1,	1},
	{"recovery",	PART_RECOVERY,	"raw data",	11,	1,	1},
	{"sec_ro",	PART_SECSTATIC,	"ext4",	12,	0,	0},
	{"misc",	PART_MISC,	"raw data",	13,	0,	0},
	{"logo",	PART_LOGO,	"raw data",	14,	1,	1},
	{"ebr2",	PART_EBR2,	"raw data",	15,	1,	1},
	{"expdb",	PART_APANIC,	"raw data",	16,	0,	0},
	{"nrstdata",	PART_NRSTDATA,	"ext4",	17,	0,	0},
	{"system",	PART_ANDSYSIMG,	"ext4",	18,	1,	1},
	{"cache",	PART_CACHE,	"ext4",	19,	1,	1},
	{"userdata",	PART_USER,	"ext4",	20,	1,	1},
	{"fat",	PART_FAT,	"fat",	21,	0,	0},
};
