...
{
	//<2013/6/28-A000000026395-davidda, [Pelican][Coverity]89854 89846  89847
	//struct bma250_i2c_data *priv = i2c_get_clientdata(client);        
	//>2013/6/28-A000000026395-davidda
...
/*----------------------------------------------------------------------------*/
//< 2013/1/15-21021-liulanqing- <[5860][drv] g-sensor auto detect>
static int bma250_probe(void)//(struct platform_device *pdev) 
//> 2013/1/15-21021-liulanqing
{
...
/*----------------------------------------------------------------------------*/
//< 2013/1/15-21021-liulanqing- <[5860][drv] g-sensor auto detect>
static int bma250_remove(void)//(struct platform_device *pdev)
//> 2013/1/15-21021-liulanqing
{
    struct acc_hw *hw = get_cust_acc_hw();
