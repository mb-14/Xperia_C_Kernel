...
//< 2013/5/16-25018-liulanqing- < [5860][drv]mtk release gsensor i2c conflict >
static DEFINE_MUTEX(sensor_mutex);
//>2013/5/16-25018-liulanqing 
...
{    
	//<2013/6/28-A000000026398-davidda, [Pelican][Coverity]89855 89797 18070 34639 89808 89809 89810 89811 89848 89849
	int err=0;
	//>2013/6/28-A000000026398-davidda
...
/*----------------------------------------------------------------------------*/
//< 2013/1/15-21021-liulanqing- <[5860][drv] g-sensor auto detect>
static int kxtj2_1009_probe(void)//(struct platform_device *pdev) 
//> 2013/1/15-21021-liulanqing
{
...
/*----------------------------------------------------------------------------*/
//< 2013/1/15-21021-liulanqing- <[5860][drv] g-sensor auto detect>
static int kxtj2_1009_remove(void)//(struct platform_device *pdev)
//> 2013/1/15-21021-liulanqing
{
    struct acc_hw *hw = get_cust_acc_hw();
