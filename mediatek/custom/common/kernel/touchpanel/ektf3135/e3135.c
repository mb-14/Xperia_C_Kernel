...
//<2013/07/23-27093-kevincheng,Update TP FW to 0x552C
...
//<2013/07/05-26621-kevincheng , Update TP FW to 0x5529
//<2013/07/16-26885-kevincheng , Update TP FW to 0x552B
//<2013/07/23-27093-kevincheng , Update TP FW to 0x552C
//<2013/07/24-27126-kevincheng , Update TP FW to 0x552D
   //if(CTP_ID == 0x55ab || CTP_ID == 0x0037)
   //   { 
       if((CTP_VER < 0x552D) || ((CTP_ID != 0x55ab) && (CTP_ID != 0x0037)))
         {
          printk(">> ID : 0x%x , FW_VER : 0x%x , need to update\n",CTP_ID,CTP_VER);
	  tpd_2wireice();
         }
   //   }
//>2013/07/24-27126-kevincheng
//>2013/07/23-27093-kevincheng
//>2013/07/16-26885-kevincheng
//>2013/07/05-26621-kevincheng
...
{
  printk( ">> [ELAN]%s: enter.. \n", __func__ );
//<2013/08/29-28601-jinxiadai,check touch pannel shortcut or connected bug
#ifndef ARIMA_PCBA_RELEASE
//<2013/9/2-NJ00000028716-KardelGao, [5875][remove workitem 28669 here]
  //<2013/8/30-NJ00000028669-KardelGao, [5875][add enter/exit sleep before tptest]
  tpd_hwPower_ctrl( Off );
  //>2013/8/30-NJ00000028669-KardelGao
  //<2013/9/2-NJ00000028716-KardelGao
#endif
//<2013/08/29-28601-jinxiadai
  mt_set_gpio_mode( GPIO_CTP_RST_PIN, GPIO_CTP_RST_PIN_M_GPIO );
  mt_set_gpio_dir( GPIO_CTP_RST_PIN, GPIO_DIR_OUT );
  mt_set_gpio_out( GPIO_CTP_RST_PIN, GPIO_OUT_ZERO );
  msleep(50);
...
//<2013/08/29-28601-jinxiadai
  ...
  return 0; //EricHsieh, Fix the coverity
} 
//>2013/07/23-27093-kevincheng
