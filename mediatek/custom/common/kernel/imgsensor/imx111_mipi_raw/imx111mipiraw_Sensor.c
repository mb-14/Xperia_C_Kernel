...
//<2013/07/09-26701-alberthsiao,[ATS00161553]fix ANR issue for FIFA camera test
	//IMX111MIPI_write_cmos_sensor(0x30C6, 0x00);//
	//IMX111MIPI_write_cmos_sensor(0x30C7, 0x00);//
//>2013/07/09-26701-alberthsiao
...
//<2013/10/18-Clark-modify delay frame from 3 to 1 by MTK ALPS01034602
