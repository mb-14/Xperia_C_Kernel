...
struct excel_info PartInfo[PART_NUM]={
			...
			{"nrstdata",5242880,0x4780000, EMMC, 5,USER},
			{"android",1048576000,0x4c80000, EMMC, 6,USER},
			{"cache",132120576,0x43480000, EMMC, 7,USER},
			{"usrdata",1073741824,0x4b280000, EMMC, 8,USER},
			{"fat",0,0x8b280000, EMMC, 9,USER},
