...
static int msensor_probe(struct platform_device *pdev) 
{
	...
	for(i = 0; i < MAX_CHOOSE_G_NUM; i++)
	{
	  ...
	  {
	  //<2013/6/26-26368-davidda, [Pelican][Coverity] 89827 Calling risky function
	  if(msensor_init_list[i]->init !=NULL)
...
*/
	...
	for(i = 0; i < MAX_CHOOSE_G_NUM; i++)
	{
	  ...
	  {
	    HWM_LOG(" !!!!!!!!\n");
	  //<2013/6/26-26368-davidda, [Pelican][Coverity] 52936 Calling risky function
	  if(gsensor_init_list[i]->init!=NULL)	
