...
{
    P_GLUE_INFO_T prGlueInfo = NULL;
    //<2013/6/26-26368-davidda, [Pelican][Coverity] 89997 Explicit null dereferenced
    P_NL80211_DRIVER_SET_KEY_EXTS prParams =NULL;// (P_NL80211_DRIVER_SET_KEY_EXTS)NULL;
    struct iw_encode_exts *prIWEncExt = NULL;//(struct iw_encode_exts *)NULL;
    //>2013/6/26-26368-davidda
    WLAN_STATUS rstatus = WLAN_STATUS_SUCCESS;
    int     fgIsValid = 0;
    UINT_32 u4BufLen = 0;
